...
class EnemyAI:
    ...
    def update(self, owner_id: int, cells, animated_connections) -> None:
        ...
        for attacker in my_cells:
            ...
            if best_tgt:
                animated_connections.append(AnimatedConnection(attacker, best_tgt))
    ...
    def _defensive_cut(self, owner_id, cells, animated_connections):
        """
        ...
        for cell in under_attack:
            while cell.connections:                   # iterate copy
                ...
                for anim in animated_connections:
